...
// ────────────────────────────────────────────────────────────────────────────
// Better Auth tables — schema dictated by Better Auth. Don't rename columns.
// ────────────────────────────────────────────────────────────────────────────
...
export const chatMessage = pgTable(
  ...
  (table) => [index("chat_message_user_id_idx").on(table.userId)],
);

export const aiPendingEvent = pgTable(
  "ai_pending_event",
  {
    id: text("id").primaryKey(),
    userId: text("user_id")
